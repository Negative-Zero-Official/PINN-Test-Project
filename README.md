...
The output statistics are detailed in [output.txt](output.txt). At its best, the PINN outperforms the CPU by a factor of 140.9372.
...
|---|---|---|
| Time per Frame | 31.46 ms | 0.22 ms |
| Max Frames Per Second | ~31.7864 FPS | ~4,545 FPS |
